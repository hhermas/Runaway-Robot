...
# measurement function: reflect the fact that we observe x and y but not the
# two velocities
H = matrix([[1., 0., 0., 0.], 
                [0., 1., 0., 0.]])
...
def next_move(hunter_position, hunter_heading, target_measurement, max_distance, OTHER=None):
    ...
    #Run kalman filter
    target_measurements_input = target_measurements[-15:]  #optimize to address "13 seconds CPU" error on Udacity
